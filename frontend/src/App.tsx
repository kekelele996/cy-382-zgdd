import { App as AntApp, Button, Card, Col, DatePicker, Form, Input, InputNumber, Layout, List, Row, Select, Statistic, Tabs } from 'antd';
    ...
    <Layout className="shell">
      ...
      <Layout.Content className="content">
        <Tabs items={[
          ...
          { key: 'diary', label: '旅行日记', children: <DiaryPage /> }
        ]} />
      </Layout.Content>
    </Layout>
  );
